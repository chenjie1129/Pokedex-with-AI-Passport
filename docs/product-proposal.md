# Original City Spirits product proposal

Historical planning document. Its original-creature scope and proposed modules describe the intended product, not all features in the current Pokémon prototype. See the [README](../README.md) for the implemented device experience.
